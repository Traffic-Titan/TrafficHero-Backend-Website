...
async def viewProfile(token: HTTPAuthorizationCredentials = Depends(HTTPBearer())):
    ...
    data = {
        ...
        "avatar": Blob.encode_image_to_base64(result["avatar"]) if "avatar" in result and result["avatar"] is None else Blob.encode_image_to_base64(Blob.urlToBlob("https://cdn.discordapp.com/attachments/989185705014071337/1137058235325620235/Default_Avatar.png")),
