...
async def get(token: HTTPAuthorizationCredentials = Depends(HTTPBearer())):
        ...
        collection_sidebar_car = await MongoDB.getCollection("traffic_hero","cms_sidebar_car")
        collection_sidebar_scooter = await MongoDB.getCollection("traffic_hero","cms_sidebar_scooter")
